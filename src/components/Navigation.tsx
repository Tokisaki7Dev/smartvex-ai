      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden lg:flex items-center gap-8 bg-white/5 px-4 py-2 rounded-full border border-white/5">
          <div className="flex items-center gap-3 pr-4 border-r border-white/10">
            <div className={`w-2 h-2 rounded-full ${user.isGuest ? 'bg-orange-500 shadow-[0_0_10px_rgba(249,115,22,0.5)]' : 'bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)]'}`}></div>
            <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-white/70">Xeon Engine: {user.isGuest ? 'Sandbox' : 'Relay Active'}</span>
          </div>
